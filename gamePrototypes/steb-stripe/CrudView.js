...
var Crud = function () {
    ...
    this.trueSPS = SPS.mutateSPS(
        steb.model.meanCrudSPS,
        steb.constants.crudSPSMutationArray
    );
 ...
 *  Called above.
 */
CrudView.prototype.setMyPattern = function () {
    this.selectionShape.attr({fill: this.crud.trueSPS.getPattern()});
...
CrudView.prototype.moveTo = function (iWhere) {
    ...
    var tTransformString =  "R " + Math.round( this.crud.angle );
