...
steb.options = {
    ...
    crudSamePatternAsBackground : true,
    eldest : false,
    ...
    setPredatorVisionParameters : function() {
        ...
        steb.model.stebbers.forEach(function(s) { s.updatePatternDistances(); });     //  update all stebbers to reflect new vision

    },

    setVisionVectorUIToMatchModelValues : function() {
        /*      //  todo: care for this method
...
/*
    ...
    doPreset : function( iPreset ) {
        ...
        switch( iPreset ) {
            case 1:
                ...
                this.crudSamePatternAsBackground = true;
    ...
    setStebOptionsToMatchUI : function() {
        ...
        this.crudSamePatternAsBackground = document.getElementById("crudSamePatternAsBackground").checked;
    ...
    setUIToMatchStebOptions : function() {
        ...
        document.getElementById("crudSamePatternAsBackground").checked = this.crudSamePatternAsBackground;
