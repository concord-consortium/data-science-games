...
var pluginHelper = {
    initDataSet: function (iDataSetDescription) {
        ...
        var tMakeNewDataContextPromise = null;
        ...
        tAlreadyExistsPromise.then(
            function( iValue ) {
                if (iValue.success) {
                    ...
                    tMakeNewDataContextPromise = codapInterface.sendRequest( tMessage );
                }
            }
        ).catch (function (msg) { console.log('warn: ' + msg);})
        return tMakeNewDataContextPromise;
    },
