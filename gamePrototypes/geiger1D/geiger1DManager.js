...
geigerManager = {
    ...
    newGame: function() {
        ...
        codapHelper.openCase(
            'games',
            [this.gameNumber, null, 0, null],
            geigerManager.setUpNewGameData
        );

        geigerLabView.setCrosshairs( geigerGameModel.sourceX);
    ...
    moveDetectorTo: function (x) {
        ...
        geigerControlPanel.displayInfo("Detector moved to (" + x + ")");
        this.updateScreen();
    },
    ...
    clickInLab: function (e) {
        ...
        geigerManager.moveDetectorTo(tX);
    },
    ...
    doMeasurement: function() {
        ...
        if (geigerGameModel.captured()) {
            ...
            codapHelper.createCase(
                'measurements',
                [geigerGameModel.detectorX, geigerGameModel.latestCount],
                this.gameCaseID
            ); // no callback?
...
codapHelper.initSim({
    name: 'Geiger',
    dimensions: {width: 404, height: 314},
